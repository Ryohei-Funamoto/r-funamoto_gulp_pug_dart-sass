...
* 各ページのファイル(assets/pug/index.pug 及び assets/pug/下層ページのフォルダ/index.pug)でassets/pug/common/_layout.pugを継承し、block pageId(任意のページID)とblock content(ページのコンテンツ)を上書きします。
